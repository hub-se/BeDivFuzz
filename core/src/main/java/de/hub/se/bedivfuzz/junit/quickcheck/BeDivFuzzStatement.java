...
import de.hub.se.bedivfuzz.guidance.SplitGeneratorGuidance;
...
public class BeDivFuzzStatement extends Statement {
    ...
    public void traceChoicesFromParameters(SplitTracingSourceOfRandomness random, GenerationStatus genStatus) {
