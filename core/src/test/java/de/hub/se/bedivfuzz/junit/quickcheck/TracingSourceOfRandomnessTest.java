...
import de.hub.se.bedivfuzz.junit.quickcheck.tracing.TracingSourceOfRandomness;
...
public class TracingSourceOfRandomnessTest {

    private static Random r;
    private RandomInput input;
    private TracingSourceOfRandomness trackingRandom;
    ...
    public void setupSourceOfRandomness() {
        ...
        trackingRandom = new TracingSourceOfRandomness(random);
    }
