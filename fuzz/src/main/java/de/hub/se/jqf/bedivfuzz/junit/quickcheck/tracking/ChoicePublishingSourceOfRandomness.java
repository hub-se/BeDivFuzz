...
public class ChoicePublishingSourceOfRandomness extends FastSourceOfRandomness {
    private final List<Choice> choiceIndices;
    private final ChoiceTrackingState trackingState;

    public ChoicePublishingSourceOfRandomness(SeedingStreamBackedRandom delegate) {
        super(delegate);
    ...
    public ChoicePublishingSourceOfRandomness(List<Choice> choiceIndices, ChoiceTrackingState trackingState) {
