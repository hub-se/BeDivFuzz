 ...
 */
public class DelegatingSplitSourceOfRandomness extends FastSourceOfRandomness implements SplitRandom {
     ...
     *
     */
    public DelegatingSplitSourceOfRandomness(SeedingStreamBackedRandom delegate) {
        super(delegate);
        delegate.initialize();
    }
