...
public class RLGuidance implements Guidance {
    ...
    /** The directory where failure stats are written. */
    ...
    protected static final long STATS_REFRESH_TIME_PERIOD = Integer.getInteger("jqf.guidance.STATS_REFRESH_TIME_PERIOD", 300);
    ...
    private void prepareOutputDirectory() throws IOException {
        ...
        this.failureStatsDirectory = new File(outputDirectory, "failure_info");
        this.failureStatsDirectory.mkdirs();
        ...
        appendLineToFile(statsFile, "# unix_time, unique_crashes, total_cov, valid_cov, total_inputs, valid_inputs, valid_paths, valid_branch_sets, unique_valid_inputs, b0, b1, b2");
    ...
    protected void handleEvent(TraceEvent e) {
        ...
        if (this.singleRunTimeoutMillis > 0 &&
                this.runStart != null) {
            long elapsedd = new Date().getTime() - runStart.getTime();
            if (elapsedd > this.singleRunTimeoutMillis) {
                throw new TimeoutException(elapsedd, this.singleRunTimeoutMillis);
            }
        }
