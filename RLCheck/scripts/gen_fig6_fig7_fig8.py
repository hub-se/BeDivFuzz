...
def plot(valid_bench, ytype):
    nicenames = {"quickcheck": "QuickCheck", 
                 ...
                 "rl": "RLCheck",
                 "div-paths": "div-Paths",
                 "div-coverage": "div-Cov",
                 "div-validity": "div-Valid",
                 "div-combined": "div-All"}

    fig, ax = plt.subplots(figsize=((6.2,4.2)))
    lss = iter(reversed(['-', '--', '-.', '-', '-', '-', '-']))
    i = 0
    for tech, replay in [('quickcheck', True), ('zest', False), ('rl', True), ('div-paths', False), ('div-coverage', False), ('div-validity', False), ('div-combined', False)]:
        color = 'C%i' % (i)
        i += 1
        ls = next(lss)
